...
#define	PI_GPIO_MASK	(0xFFFFFF80)
...
#define	PI_VERSION_3		4
#define	PI_VERSION_4		5
...
extern volatile unsigned int *_wiringPiGpioPinMux ;
...
extern          void pwmSetFreq          (int pin, unsigned int frequency);
extern          void pwmSetDuty          (int pin, unsigned int duty_cycle_ns);
